...
style="background-image:url('gambar2.jpg'); background-size:cover;">
    ...
    <p>
        <font size="10" face="Brush Script MT">
            <a href="pendaftaran.php" style="color:white; text-decoration:none;">Pendaftaran</a>
        </font>
    </p>
    <p>
        <font size="10" face="Brush Script MT">
            <a href="pendaftaran.php?menu=data" style="color:white; text-decoration:none;">Data Pendaftar</a>
        </font>
    </p>
    <p>
        <font size="10" face="Brush Script MT">
            <a href="../" style="color:#ffd700; text-decoration:none; font-weight:bold;">Portal Utama</a>
        </font>
    </p>
