...
style="background-image:url('{{ asset('uts_assets/gambar2.jpg') }}'); background-size:cover;">
    ...
    <p>
        <font size="10" face="Brush Script MT">
            <a href="{{ url('/uts/pendaftaran?menu=data') }}" style="color:white; text-decoration:none;">
                Data Pendaftar
            </a>
        </font>
    </p>
...
<!-- ISI -->
<td align="center"
style="background-image:url('{{ asset('uts_assets/gambar1.jpg') }}'); background-size:cover;">
